...
const resources = {
  en: {
    translation: {
      ...
      free: 'FREE',
      free_delivery_note: 'Free delivery on orders above ₹500',
      total: 'Total',
      proceed_checkout: 'Proceed to Checkout',
      delivery_address: 'Delivery Address',
      full_name: 'Full Name',
      address_line: 'Address Line (House No., Street)',
      city: 'City',
      pincode: 'Pincode',
      fill_address: 'Please fill all address fields',
      valid_phone: 'Please enter a valid 10-digit phone number',
      continue: 'Continue',
      payment_method: 'Select Payment Method',
      cash_on_delivery: 'Cash on Delivery',
      pay_cash: 'Pay when you receive',
      upi: 'UPI',
      gpay_phonepe: 'GPay, PhonePe, Paytm',
      credit_debit_card: 'Credit/Debit Card',
      visa_mastercard: 'Visa, Mastercard, Rupay',
      net_banking: 'Net Banking',
      all_banks: 'All major banks',
      items: 'Items',
      ...
      order_something: 'Start shopping to see your orders here',
      payment_summary: 'Payment Summary',
      delivery_otp: 'Delivery OTP',
      share_otp: 'Share this OTP with delivery person',
  ...
  hi: {
    translation: {
      ...
      free: 'निःशुल्क',
      free_delivery_note: '₹500 से अधिक के ऑर्डर पर निःशुल्क डिलीवरी',
      total: 'कुल',
      proceed_checkout: 'चेकआउट के लिए आगे बढ़ें',
      delivery_address: 'डिलीवरी पता',
      full_name: 'पूरा नाम',
      address_line: 'पता पंक्ति (घर नंबर, गली)',
      city: 'शहर',
      pincode: 'पिनकोड',
      fill_address: 'कृपया सभी पता फ़ील्ड भरें',
      valid_phone: 'कृपया वैध 10-अंकीय फोन नंबर दर्ज करें',
      continue: 'जारी रखें',
      payment_method: 'भुगतान विधि चुनें',
      cash_on_delivery: 'कैश ऑन डिलीवरी',
      pay_cash: 'प्राप्त होने पर भुगतान करें',
      upi: 'यूपीआई',
      gpay_phonepe: 'जीपे, फोनपे, पेटीएम',
      credit_debit_card: 'क्रेडिट/डेबिट कार्ड',
      visa_mastercard: 'वीज़ा, मास्टरकार्ड, रुपे',
      net_banking: 'नेट बैंकिंग',
      all_banks: 'सभी प्रमुख बैंक',
      items: 'आइटम',
      ...
      days: 'दिन',
      view_orders: 'मेरे ऑर्डर देखें',
      order_failed: 'ऑर्डर देने में विफल। कृपया पुनः प्रयास करें।',
      address: 'पता',
      payment: 'भुगतान',
      confirmation: 'पूर्ण',
      ...
      order_something: 'अपने ऑर्डर यहां देखने के लिए खरीदारी शुरू करें',
      payment_summary: 'भुगतान सारांश',
      delivery_otp: 'डिलीवरी ओटीपी',
      share_otp: 'यह ओटीपी डिलीवरी व्यक्ति के साथ साझा करें',
  ...
  te: {
    translation: {
      ...
      // Cart & Checkout
      cart_empty: 'మీ కార్ట్ ఖాలీగా ఉంది',
      continue_shopping: 'షాపింగ్ కొనసాగించండి',
      remove: 'తొలగించండి',
      order_summary: 'ఆర్డర్ సారాంశం',
      subtotal: 'ఉపమొత్తం',
      delivery: 'డెలివరీ చార్జీ',
      free: 'ఉచితం',
      free_delivery_note: '₹500 పై అందుబాటులో ఉన్న ఆర్డర్లకు ఉచిత డెలివరీ',
      total: 'మొత్తం',
      proceed_checkout: 'చెక్‌అవుట్కు ముందుకు వెళ్ళండి',
      delivery_address: 'డెలివరీ చిరునామా',
      full_name: 'పూర్తి పేరు',
      address_line: 'చిరునామా లైన్ (ఇంటి నం., వీధి)',
      city: 'నగరం',
      pincode: 'పిన్‌కోడ్',
      fill_address: 'దయచేసి అన్ని చిరునామా ఫీల్డ్‌లను పూర్తి చేయండి',
      valid_phone: 'దయచేసి చెల్లుబాటు 10-అంకాల ఫోన్ నంబర్‌ను ప్రవేశపెట్టండి',
      continue: 'కొనసాగించండి',
      payment_method: 'చెల్లింపు పద్ధతిని ఎంచుకోండి',
      cash_on_delivery: 'క్యాష్ ఆన్ డెలివరీ',
      pay_cash: 'ప్రాప్తిస్తున్నప్పుడు చెల్లించండి',
      upi: 'యూపీఆఈ',
      gpay_phonepe: 'జీపే, ఫోన్పే, పేటీఎం',
      credit_debit_card: 'క్రెడిట్/డెబిట్ కార్డ్',
      visa_mastercard: 'వీసా, మాస్టర్కార్డ్, రూపే',
      net_banking: 'నెట్ బ్యాంకింగ్',
      all_banks: 'అన్ని ప్రముఖ బ్యాంకులు',
      items: 'అంశాలు',
      total_amount: 'మొత్తం మొత్తం',
      processing: 'ప్రాసెస్ అవుతోంది...',
      place_order: 'ఆర్డర్ ఇవ్వండి',
      order_placed: 'ఆర్డర్ విజయవంతంగా ఇచ్చబడింది!',
      order_id: 'ఆర్డర్ ఐడీ',
      delivery_to: 'డెలివరీ చేస్తున్న చోటు',
      estimated_delivery: 'అనుమానిత డెలివరీ',
      days: 'రోజులు',
      view_orders: 'నా ఆర్డర్‌లను చూడండి',
      order_failed: 'ఆర్డర్ ఇవ్వడం విఫలం అయ్యింది. దయచేసి మళ్లీ ప్రయత్నించండి.',
      address: 'చిరునామా',
      payment: 'చెల్లింపు',
      confirmation: 'పూర్తియైంది',
      
      // Orders Page
      order: 'ఆర్డర్',
      pending: 'వెంటారుగా ఉంది',
      confirmed: 'నిర్ధారించబడింది',
      shipped: 'పంపబడింది',
      delivered: 'డెలివర్ అయ్యింది',
      more_items: 'ఇంకా అంశాలు',
      order_details: 'ఆర్డర్ వివరాలు',
      order_status: 'ఆర్డర్ స్థితి',
      loading: 'ఆర్డర్‌లు లోడ్ అవుతున్నాయి...',
      no_orders: 'ఇప్పటివరకు ఆర్డర్‌లు లేవు',
      order_something: 'మీ ఆర్డర్‌లను ఇక్కడ చూడడానికి షాపింగ్ ప్రారంభించండి',
      payment_summary: 'చెల్లింపు సారాంశం',
      delivery_otp: 'డెలివరీ ఓటీపీ',
      share_otp: 'ఈ ఓటీపీని డెలివరీ వ్యక్తితో పంచుకోండి',
  ...
  ta: {
    translation: {
      ...
      continue_shopping: 'வாங்குதலை தொடரவும்',
      remove: 'நீக்கு',
      order_summary: 'ஆணை சுருக்கம்',
      subtotal: 'துணை முட்டல்',
      delivery: 'விதரணா கட்டணம்',
      free: 'இலவசம்',
      free_delivery_note: '₹500-க்கு மேற்பட்ட ஆணைகளுக்கு இலவச விதரணா',
      total: 'முட்டல்',
      proceed_checkout: 'செக்-ஆஉட்டுக்கு செல்க',
      delivery_address: 'விதரணா முகவரி',
      full_name: 'முழு பெயர்',
      address_line: 'முகவரி வரி (வீடு எண்., தெரு)',
      city: 'நகரம்',
      pincode: 'பின்கோடு',
      fill_address: 'அனைத்து முகவரி களங்களையும் நிரப்பவும்',
      valid_phone: 'சரியான 10-இலக்க தொலைபேசி எண்ணை உள்ளிடவும்',
      continue: 'தொடரவும்',
      payment_method: 'செலுத்தும் முறையை தேர்வு செய்க',
      cash_on_delivery: 'விதரணாயில் நகது',
      pay_cash: 'பெறும்போது செலுத்துங்கள்',
      upi: 'யூபிஆயி',
      gpay_phonepe: 'ஜிபே, போன்பே, பேடீஎம்',
      credit_debit_card: 'கிரெடிட்/டெபிட் கார்டு',
      visa_mastercard: 'விசா, மாஸ்டர்கார்டு, ரூபே',
      net_banking: 'நெட் வங்கி',
      all_banks: 'அனைத்து ப்ரதான வங்கிகள்',
      items: 'பொருட்கள்',
      total_amount: 'முட்டல் தொகை',
      processing: 'செயலாக்குகிறது...',
      place_order: 'ஆணை இடு',
      order_placed: 'ஆணை வெற்றிகரமாக இடப்பட்டது!',
      order_id: 'ஆணை ஐடி',
      delivery_to: 'விதரணை செய்யும் இடம்',
      estimated_delivery: 'மதிப்பிடப்பட்ட விதரணா',
      days: 'நாட்கள்',
      view_orders: 'என் ஆணைகளைப் பார்க்கவும்',
      order_failed: 'ஆணை இட தவறியது. மீண்டும் முயற்சிக்கவும்.',
      address: 'முகவரி',
      payment: 'செலுத்துதல்',
      confirmation: 'முடிந்தது',
      ...
      delivered: 'விதரணை செய்யப்பட்டது',
      more_items: 'மேலும் பொருட்கள்',
      order_details: 'ஆணை விவரங்கள்',
      order_status: 'ஆணை நிலை',
      loading: 'ஆணைகளை ஏற்றுகிறது...',
      no_orders: 'இன்னும் ஆணைகள் இல்லை',
      order_something: 'உங்கள் ஆணைகளை இங்கே பார்க்க வாங்குதலை தொடங்குங்கள்',
      payment_summary: 'செலுத்தும் சுருக்கம்',
      delivery_otp: 'விதரணா ஓடிபி',
      share_otp: 'இந்த ஓடிபியை விதரணா நபருடன் பகிரவும்',
  ...
  ml: {
    translation: {
      ...
      order_summary: 'ഓർഡർ സാരാംശം',
      subtotal: 'ഉപമൊത്തം',
      delivery: 'ഡെലിവറി ചാർജ്ജ്',
      free: 'സൗജന്യം',
      free_delivery_note: '₹500-നു മേലുള്ള ഓർഡറുകൾക്ക് സൗജന്യ ഡെലിവറി',
      total: 'മൊത്തം',
      proceed_checkout: 'ചെക്-ആഉട്ടു തുടരുക',
      delivery_address: 'ഡെലിവറി വിലാസം',
      full_name: 'മുഴുവൻ പേര്',
      address_line: 'വിലാസ ലൈൻ (വീട് നം., തെരുവ്)',
      city: 'നഗരം',
      pincode: 'പിൻകോഡ്',
      fill_address: 'എല്ലാ വിലാസ ഫീൽഡുകളും പൂരിപ്പിക്കുക',
      valid_phone: 'സാധുവായ 10-അക്കത്തെ ഫോൺ നമ്പർ നൽകുക',
      continue: 'തുടരുക',
      payment_method: 'പെയ്‌മെന്റ് വിധി തിരഞ്ഞെടുക്കുക',
      cash_on_delivery: 'ക്യാഷ് ഓൺ ഡെലിവറി',
      pay_cash: 'ലഭിക്കുമ്പോൾ പൈസ നൽകുക',
      upi: 'യൂപിഐ',
      gpay_phonepe: 'ജിപേ, ഫോൺപേ, പേടിഎം',
      credit_debit_card: 'ക്രെഡിറ്റ്/ഡെബിറ്റ് കാർഡ്',
      visa_mastercard: 'വീസ, മാസ്റ്റർകാർഡ്, റൂപേ',
      net_banking: 'നെറ്റ് ബാങ്കിംഗ്',
      all_banks: 'എല്ലാ പ്രധാന ബാങ്കുകളും',
      items: 'ഉത്പന്നങ്ങൾ',
      ...
      order_id: 'ഓർഡർ ഐഡി',
      delivery_to: 'ഡെലിവർ ചെയ്യുന്ന സ്ഥലം',
      estimated_delivery: 'പ്രതീക്ഷിച്ച ഡെലിവറി',
      days: 'ദിവസങ്ങൾ',
      view_orders: 'എന്റെ ഓർഡറുകൾ കാണുക',
      order_failed: 'ഓർഡർ നൽകുന്നതിൽ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.',
      address: 'വിലാസം',
      payment: 'പെയ്‌മെന്റ്',
      confirmation: 'പൂർത്തീകരിച്ചു',
      ...
      more_items: 'കൂടുതൽ ഉത്പന്നങ്ങൾ',
      order_details: 'ഓർഡർ വിശദാംശങ്ങൾ',
      order_status: 'ഓർഡർ സ്ഥിതി',
      loading: 'ഓർഡറുകൾ ലോഡ് ചെയ്യുന്നു...',
      no_orders: 'ഇനിയും ഓർഡറുകൾ ഇല്ല',
      order_something: 'നിങ്ങളുടെ ഓർഡറുകൾ ഇവിടെ കാണാൻ വാങ്ങൽ ആരംഭിക്കുക',
      payment_summary: 'പെയ്‌മെന്റ് സാരാംശം',
      delivery_otp: 'ഡെലിവറി ഓടിപി',
      share_otp: 'ഈ ഓടിപി ഡെലിവറി വ്യക്തിയുമായി പങ്കിടുക',
  ...
  kn: {
    translation: {
      ...
      free: 'ಉಚಿತ',
      free_delivery_note: '₹500 ಕ್ಕಿಂತ ಹೆಚ್ಚಿನ ಆರ್ಡರ್‌ಗಳಿಗೆ ಉಚಿತ ಡೆಲಿವರಿ',
      total: 'ಒಟ್ಟು',
      proceed_checkout: 'ಚೆಕ್‌ಔಟ್‌ಗೆ ಮುಂದುವರಿಯಿರಿ',
      delivery_address: 'ಡೆಲಿವರಿ ವಿಳಾಸ',
      full_name: 'ಪೂರ್ಣ ಹೆಸರು',
      address_line: 'ವಿಳಾಸ ಸಾಲು (ಮನೆ ಸಂ., ಬೀದಿ)',
      city: 'ನಗರ',
      pincode: 'ಪಿನ್‌ಕೋಡ್',
      fill_address: 'ದಯವಿಟ್ಟು ಎಲ್ಲಾ ವಿಳಾಸ ಕ್ಷೇತ್ರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ',
      valid_phone: 'ದಯವಿಟ್ಟು ಮಾನ್ಯವಾದ 10-ಅಂಕಿಯ ಫೋನ್ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ',
      continue: 'ಮುಂದುವರಿಸಿ',
      payment_method: 'ಪಾವತಿ ವಿಧಾನವನ್ನು ಆಯ್ಕೆಮಾಡಿ',
      cash_on_delivery: 'ಕ್ಯಾಶ್ ಆನ್ ಡೆಲಿವರಿ',
      pay_cash: 'ಸ್ವೀಕರಿಸಿದಾಗ ಪಾವತಿಸಿ',
      upi: 'ಯುಪಿಐ',
      gpay_phonepe: 'ಜಿಪೇ, ಫೋನ್‌ಪೇ, ಪೇಟಿಎಂ',
      credit_debit_card: 'ಕ್ರೆಡಿಟ್/ಡೆಬಿಟ್ ಕಾರ್ಡ್',
      visa_mastercard: 'ವೀಸಾ, ಮಾಸ್ಟರ್‌ಕಾರ್ಡ್, ರೂಪೇ',
      net_banking: 'ನೆಟ್ ಬ್ಯಾಂಕಿಂಗ್',
      all_banks: 'ಎಲ್ಲಾ ಪ್ರಮುಖ ಬ್ಯಾಂಕುಗಳು',
      items: 'ವಸ್ತುಗಳು',
      ...
      order_id: 'ಆರ್ಡರ್ ಐಡಿ',
      delivery_to: 'ಡೆಲಿವರಿ ಮಾಡುವ ಸ್ಥಳ',
      estimated_delivery: 'ಅಂದಾಜು ಡೆಲಿವರಿ',
      days: 'ದಿನಗಳು',
      view_orders: 'ನನ್ನ ಆರ್ಡರ್‌ಗಳನ್ನು ವೀಕ್ಷಿಸಿ',
      order_failed: 'ಆರ್ಡರ್ ನೀಡಲು ವಿಫಲವಾಗಿದೆ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
      address: 'ವಿಳಾಸ',
      payment: 'ಪಾವತಿ',
      confirmation: 'ಪೂರ್ಣಗೊಂಡಿದೆ',
      ...
      more_items: 'ಹೆಚ್ಚಿನ ವಸ್ತುಗಳು',
      order_details: 'ಆರ್ಡರ್ ವಿವರಗಳು',
      order_status: 'ಆರ್ಡರ್ ಸ್ಥಿತಿ',
      loading: 'ಆರ್ಡರ್‌ಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...',
      no_orders: 'ಇನ್ನೂ ಆರ್ಡರ್‌ಗಳಿಲ್ಲ',
      order_something: 'ನಿಮ್ಮ ಆರ್ಡರ್‌ಗಳನ್ನು ಇಲ್ಲಿ ನೋಡಲು ಶಾಪಿಂಗ್ ಪ್ರಾರಂಭಿಸಿ',
      payment_summary: 'ಪಾವತಿ ಸಾರಾಂಶ',
      delivery_otp: 'ಡೆಲಿವರಿ ಓಟಿಪಿ',
      share_otp: 'ಈ ಓಟಿಪಿಯನ್ನು ಡೆಲಿವರಿ ವ್ಯಕ್ತಿಯೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಿ',
  ...
  mr: {
    translation: {
      ...
      free: 'मोफत',
      free_delivery_note: '₹500 पेक्षा जास्त ऑर्डरवर मोफत डिलिव्हरी',
      total: 'एकूण',
      proceed_checkout: 'चेकआउटवर जा',
      delivery_address: 'डिलिव्हरी पत्ता',
      full_name: 'पूर्ण नाव',
      address_line: 'पत्ता ओळ (घर क्रं., रस्ता)',
      city: 'शहर',
      pincode: 'पिनकोड',
      fill_address: 'कृपया सर्व पत्ता फील्ड भरा',
      valid_phone: 'कृपया वैध 10-अंकी फोन नंबर टाका',
      continue: 'सुरू ठेवा',
      payment_method: 'पेमेंट पद्धत निवडा',
      cash_on_delivery: 'कॅश ऑन डिलिव्हरी',
      pay_cash: 'मिळाल्यावर पैसे द्या',
      upi: 'यूपीआय',
      gpay_phonepe: 'जीपे, फोनपे, पेटीएम',
      credit_debit_card: 'क्रेडिट/डेबिट कार्ड',
      visa_mastercard: 'व्हिसा, मास्टरकार्ड, रुपे',
      net_banking: 'नेट बँकिंग',
      all_banks: 'सर्व प्रमुख बँका',
      items: 'वस्तू',
      total_amount: 'एकूण रक्कम',
      processing: 'प्रक्रिया करत आहे...',
      place_order: 'ऑर्डर द्या',
      order_placed: 'ऑर्डर यशस्वीपणे दिली!',
      order_id: 'ऑर्डर आयडी',
      delivery_to: 'डिलिव्हरी स्थळ',
      estimated_delivery: 'अंदाजे डिलिव्हरी',
      days: 'दिवस',
      view_orders: 'माझे ऑर्डर पहा',
      order_failed: 'ऑर्डर देताना अयशस्वी. कृपया पुन्हा प्रयत्न करा.',
      address: 'पत्ता',
      payment: 'पेमेंट',
      confirmation: 'पूर्ण झाले',
      ...
      shipped: 'पाठवली',
      delivered: 'वितरित',
      more_items: 'अधिक वस्तू',
      order_details: 'ऑर्डर तपशील',
      order_status: 'ऑर्डर स्थिती',
      loading: 'ऑर्डर लोड करत आहे...',
      no_orders: 'अद्याप ऑर्डर नाहीत',
      order_something: 'तुमची ऑर्डर येथे पाहण्यासाठी खरेदी सुरू करा',
      payment_summary: 'पेमेंट सारांश',
      delivery_otp: 'डिलिव्हरी ओटीपी',
      share_otp: 'ही ओटीपी डिलिव्हरी व्यक्तीसोबत शेअर करा',
